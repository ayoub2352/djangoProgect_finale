...
class VoyageFilter(django_filters.FilterSet):
    ...
    date_depart = django_filters.DateFilter(field_name='date_depart', lookup_expr='gte', widget=forms.TextInput(attrs={"class": "form-control","placeholder":"Date de départ",'id': 'checkin_date','readonly': 'readonly'}))
    date_arrivee = django_filters.DateFilter(field_name='date_depart', lookup_expr='lte', widget=forms.TextInput(attrs={"class": "form-control","placeholder":"Date d'arrivée",'id': 'checkin_date','readonly': 'readonly'}))
